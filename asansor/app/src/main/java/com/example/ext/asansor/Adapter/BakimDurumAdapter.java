...
public class BakimDurumAdapter  extends BaseAdapter {
    List<BakimPojo> BakimPojoPojoList;
    Context context;

    public BakimDurumAdapter(List<BakimPojo> BakimPojoPojoList, Context context) {
    ...
    public View getView(int position, View converView, ViewGroup parent) {
        converView= LayoutInflater.from(context).inflate(R.layout.bakim_durum_layout,parent,false);
