...
public class IlanDetayPojo{
	...
	public void setOrtalamyakit(String ortalamyakit){
		this.ortalamyakit = ortalamyakit;
	}

	public String getOrtalamyakit(){
		return ortalamyakit;
	}
